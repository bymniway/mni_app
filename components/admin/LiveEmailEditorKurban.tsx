...
//         <div className='absolute top-10 right-10 text-[120px] opacity-[0.03] pointer-events-none select-none'>
//           🐄
//         </div>
...
//   // DESAIN 2: AWAL BOOKING (Kuning Elegan) - TAB BARU
...
//         <div className='absolute top-4 right-8 text-[80px] opacity-[0.03] pointer-events-none select-none'>
//           🐄
//         </div>
