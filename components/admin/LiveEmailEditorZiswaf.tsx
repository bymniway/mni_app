...
//               )
//             }
//             className={`text-lg font-bold text-teal-800 ${editableClass}`}>
...
//         </div>
//       </div>
//       <div className='bg-slate-50 p-10 flex items-center justify-between'>
//         <div className='text-[10px] text-slate-400 max-w-[200px]'>
//           E-Invoice diterbitkan secara resmi oleh Panitia Masjid MNI.
//         </div>
...
//               />
//             ) : (
//               <div className='w-full h-full border-2 border-dashed border-slate-200 rounded-full flex items-center justify-center text-[10px] font-black text-slate-300 rotate-12'>
//                 STAMP
//               </div>
//             )}
//             {isEditor && (
...
//   // DESAIN 2: MENUNGGU (Informasi / Pending Notice)
...
//   // DESAIN 3: DITOLAK (Alert / Peringatan)
//   const renderDitolak = () => (
...
//           {/* ✅ BAGIAN YANG BISA DIEDIT LIVE SEKARANG */}
//           <span
//             contentEditable={isEditor}
//             suppressContentEditableWarning
//             onBlur={(e) =>
