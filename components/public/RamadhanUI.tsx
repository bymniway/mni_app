        ...
        <div className='w-full sm:w-auto overflow-x-auto hide-scrollbar'>
          <div className='bg-white p-1.5 rounded-full border border-slate-200 flex shadow-sm gap-1.5 w-max mx-auto'>
            <button
              ...
              className={`group relative overflow-hidden justify-center flex items-center px-5 py-3 rounded-full font-medium hover:scale-[1.03] active:scale-95 transition-all text-sm ${activeTab === 'imam' ? 'bg-emerald-700 text-white shadow-md' : 'text-slate-500'}`}>
            ...
            <button
              ...
              className={`group relative overflow-hidden justify-center flex items-center px-5 py-3 rounded-full font-medium hover:scale-[1.03] active:scale-95 transition-all text-sm ${activeTab === 'takjil' ? 'bg-mni-accent text-white shadow-md' : 'text-slate-500'}`}>
            ...
            <button
              ...
              className={`group relative overflow-hidden justify-center flex items-center px-5 py-3 rounded-full font-medium hover:scale-[1.03] active:scale-95 transition-all text-sm ${activeTab === 'laporan' ? 'bg-slate-800 text-white shadow-md' : 'text-slate-500 hover:bg-slate-100'}`}>
