...
//       {/* PENAMBAHAN GAP DI MODE GAMBAR KECIL AGAR TIDAK MENUMPUK SAAT HOVER */}
//       <div
//         ref={scrollRef}
...
//       {/* ========================================== */}
//       {/* GRID FEED INSTAGRAM (4:5 Ratio, Grid Gap Dirapatkan Kembali) */}
//       {/* ========================================== */}
...
//                 key={item.id}
//                 className={`group relative rounded-[10px] overflow-hidden aspect-[4/5] bg-mni-surface block shadow-sm ${!isEditor ? 'cursor-pointer hover:shadow-lg' : ''}`}>
//                 {isEditor && (
//                   <button
//                     onClick={(e) => {
//                       e.stopPropagation();
...
//                         )
//                       }
//                       className={`inline-block px-2.5 py-0.5 bg-mni-accent text-white text-[9px] font-bold rounded-full mb-1.5 uppercase tracking-wider ${editableClass} pointer-events-auto shadow-sm`}>
...
//                         )
//                       }
//                       className={`text-white font-bold text-sm md:text-base leading-tight line-clamp-2 ${editableClass} pointer-events-auto w-full`}>
...
//                         )
//                       }
//                       className={`text-white/80 text-[10px] md:text-[11px] leading-snug line-clamp-2 ${editableClass} pointer-events-auto w-full`}>
//                       {item.deskripsi || 'Ketik deskripsi kegiatan di sini...'}
//                     </p>
//                   </div>

//                   {/* KANAN: TOMBOL INTERAKSI (Vertikal, Polos) */}
//                   {!isEditor && (
...
//                             ? '...'
//                             : formatAngka(interactionData[item.id]?.likes || 0)}
//                         </span>
//                       </button>
...
//                             ? '...'
//                             : formatAngka(
//                                 interactionData[item.id]?.comments?.length || 0,
//                               )}
//                         </span>
//                       </button>
...
//                 {/* FORM KOMENTAR INLINE (Dirampingkan agar tidak tumpah) */}
//                 <AnimatePresence>
...
//             {/* HEADER LIGHTBOX (Kategori, Judul, Tanggal) */}
...
//               {/* TOMBOL LIKE/SHARE (Desktop Kanan Bawah, Mobile Menyesuaikan Form Komen) */}
