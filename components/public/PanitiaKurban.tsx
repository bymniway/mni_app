...
//   // Class untuk memberikan efek highlight saat mode admin (agar ketahuan mana yang bisa diklik)
...
//             {/* Teks Judul Dibungkus span agar ikon Shield tidak terhapus saat diketik */}
//             <span
...
//               variants={fadeInUp}
//               key={panitia.id}
//               className='bg-white p-5 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md hover:border-green-200 transition-all group relative overflow-hidden flex items-center gap-4'>
//               {/* EFEK HOVER IKON RAKSASA */}
//               <div className='absolute -right-4 -bottom-4 opacity-[0.03] group-hover:scale-150 transition-transform duration-700 pointer-events-none z-0'>
//                 <UserCheck className='w-32 h-32 text-mni-primary' />
//               </div>

//               {/* Hapus Panitia (Hanya muncul jika isEditor) */}
//               {isEditor && (
//                 <button
//                   onClick={() => onPanitiaDelete && onPanitiaDelete(panitia.id)}
//                   className='absolute top-2 right-2 p-1.5 bg-red-50 text-red-500 rounded-full opacity-0 group-hover:opacity-100 hover:bg-red-500 hover:text-white transition-all z-20 shadow-sm'
//                   title='Hapus Panitia'>
//                   <X className='w-4 h-4' />
//                 </button>
//               )}
...
//                 {/* Upload Image Overlay (Hanya muncul jika isEditor) */}
//                 {isEditor && (
...
//                     )
//                   }
//                   className={`font-bold text-gray-900 text-base truncate group-hover:text-mni-primary transition-colors ${editableClass}`}>
...
//                     )
//                   }
//                   className={`text-[10px] font-bold text-mni-primary uppercase tracking-wider bg-green-50 border border-green-100 px-2 py-1 rounded-lg inline-block mt-1.5 truncate max-w-full ${editableClass}`}>
