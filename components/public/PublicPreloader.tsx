...
export default function PublicPreloader() {
  ...
  }, [mounted, isExcluded]); // Tambahkan isExcluded ke dependency array
      ...
      {isLoading && (
        <motion.div
          ...
          <div className='relative z-10 flex flex-col items-center'>
            ...
            <div className='h-[45px] md:h-[60px] overflow-hidden relative w-[300px] md:w-[500px] flex justify-center'>
              <motion.div
                ...
                {slotItems.map((item, index) => (
                  <div
                    key={index}
                    className='h-[45px] md:h-[60px] w-full flex items-center justify-center text-white text-xl md:text-2xl font-bold text-center racking-tight shrink-0'>
                    {item}
                  </div>
                ))}
              </motion.div>
