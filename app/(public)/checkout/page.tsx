...
//     // Tangkap semua data ke FormData tapi JANGAN dikirim dulu
...
//         <p className='font-bold text-teal-700 animate-pulse'>
...
//                 {/* Tombol Tambah Slot/Ekor tampil untuk semua jenis kurban */}
//                 <button
//                   type='button'
//                   onClick={addMudhohi}
//                   className='flex items-center text-xs font-medium text-slate-600 bg-slate-100 px-3 py-1.5 rounded-lg hover:bg-slate-200 transition shadow-sm border border-slate-200'>
...
//                   <div
//                     key={index}
//                     className='p-5 bg-white border border-slate-100 rounded-xl relative shadow-sm hover:shadow-md transition-all'>
...
//                             className='flex items-center text-[10px] font-bold text-teal-600 bg-teal-50 px-2.5 py-1.5 rounded-lg hover:bg-teal-100 border border-teal-100 uppercase tracking-wide transition'>
...
//                             className='text-slate-300 hover:text-red-500 ml-1 transition bg-slate-50 hover:bg-red-50 p-1.5 rounded-md border border-slate-100 hover:border-red-100'>
...
//                             className='w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 outline-none transition-all text-sm font-medium'
//                           />
//                         </div>
//                       </div>
...
//                       {isUrunan ? (
//                         <div
//                           className='flex items-center bg-slate-50 border border-slate-200 p-3.5 rounded-lg cursor-pointer hover:bg-slate-100 transition-colors'
//                           onClick={() =>
//                             updateMudhohi(
//                               index,
//                               'ambilSepertiga',
...
//                           }>
//                           <div
//                             className={`w-5 h-5 rounded flex items-center justify-center mr-3 border ${mudhohi.ambilSepertiga ? 'bg-teal-600 border-teal-600' : 'bg-white border-slate-300'}`}>
//                             {mudhohi.ambilSepertiga && (
...
//                       <div className='grid grid-cols-1 md:grid-cols-2 gap-4 pt-3 mt-3 border-t border-slate-50'>
//                         <div>
//                           <label className='block text-xs font-bold text-slate-500 mb-1.5 uppercase tracking-wide'>
//                             No. WhatsApp *
//                           </label>
...
//                               className='w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-teal-600/30 focus:border-teal-500 outline-none transition-all text-sm font-medium'
//                             />
//                           </div>
//                         </div>
...
//                               className='w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-teal-500/20 focus:border-teal-500 outline-none transition-all text-sm font-medium resize-none'
//                             />
//                           </div>
//                         </div>
//                       </div>
...
//                 <ShieldCheck className='w-5 h-5 mr-2 text-teal-600' /> Metode
//                 Pembayaran
//               </h2>
...
//                   <label
//                     className={`cursor-pointer border-2 p-4 rounded-xl flex flex-col items-center justify-center text-center transition-all ${metode === 'Lunas' ? 'border-teal-600 bg-teal-50/50 shadow-sm' : 'border-slate-100 hover:border-teal-200 bg-white hover:bg-slate-50'}`}>
//                     <input
//                       type='radio'
//                       name='metode'
//                       value='Lunas'
...
//                     />
//                     <span
//                       className={`text-sm font-bold ${metode === 'Lunas' ? 'text-teal-800' : 'text-slate-500'}`}>
//                       Bayar Lunas
//                     </span>
//                   </label>
//                   <label
//                     className={`cursor-pointer border-2 p-4 rounded-xl flex flex-col items-center justify-center text-center transition-all ${metode === 'Booking' ? 'border-teal-600 bg-teal-50/50 shadow-sm' : 'border-slate-100 hover:border-teal-200 bg-white hover:bg-slate-50'}`}>
//                     <input
//                       type='radio'
//                       name='metode'
//                       value='Booking'
...
//                     />
//                     <span
//                       className={`text-sm font-bold ${metode === 'Booking' ? 'text-teal-800' : 'text-slate-500'}`}>
...
//                       Transfer Bank BSI
//                     </p>
//                     <p className='font-mono text-xl font-bold text-slate-800 tracking-wider mb-1'>
//                       712 345 6789
//                     </p>
//                     <p className='text-xs font-semibold text-slate-600'>
//                       a.n Masjid Nurul Iman
//                     </p>
//                   </div>
//                   <label className='block text-xs font-bold text-slate-500 mb-2 uppercase tracking-wide'>
//                     Unggah Bukti Transfer *
//                   </label>
//                   <div className='border-2 border-dashed border-slate-300 bg-slate-50 rounded-xl p-8 text-center hover:bg-teal-50 hover:border-teal-300 transition-colors cursor-pointer relative'>
//                     <UploadCloud className='w-8 h-8 text-teal-500 mx-auto mb-3' />
//                     <p className='text-sm font-semibold text-slate-700'>
//                       {file ? file.name : 'Klik untuk pilih foto / screenshot'}
//                     </p>
//                     <input
//                       type='file'
//                       accept='image/*'
...
//                 </div>
//               ) : (
//                 <div className='bg-slate-50 p-5 rounded-xl border border-slate-200 text-slate-600 text-sm text-center font-medium'>
...
//           <div className='bg-white p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-sm sticky top-6'>
//             <h3 className='font-bold text-lg text-slate-800 mb-6 flex items-center border-b border-slate-100 pb-4'>
//               Ringkasan Pesanan
//             </h3>
...
//                 <span className='font-bold text-teal-600'>+ Rp {kodeUnik}</span>
//               </div>
//               <div className='border-t border-slate-200 pt-5 mt-5'>
//                 <span className='block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1'>
//                   Total Bayar
//                 </span>
//                 <span className='block text-3xl font-bold text-teal-800 tracking-tight'>
//                   {formatRupiah(totalBayar)}
//                 </span>
//               </div>
//             </div>

//             {/* Tombol yang akan memicu Modal Niat (lewat handleSubmit) */}
//             <button
//               type='submit'
//               form='checkout-form'
//               className='w-full mt-8 bg-teal-700 text-white py-4 rounded-xl text-base font-bold hover:bg-teal-800 transition-colors disabled:bg-slate-300 disabled:cursor-not-allowed flex justify-center shadow-md shadow-teal-900/10'>
...
//               <div className='bg-teal-50 border border-teal-100 rounded-2xl p-6 mb-8 mt-4 relative'>
//                 <p
//                   className='text-2xl font-bold text-teal-900 leading-relaxed mb-4 font-arabic'
...
//                   disabled={isLoading}
//                   className='flex-1 py-3.5 rounded-xl font-bold text-white bg-teal-700 hover:bg-teal-800 flex items-center justify-center transition shadow-md'>
//                   {isLoading ? (
