...
//         {/* ==================================================== */}
//         {/* BAGIAN KIRI: KONTEN UTAMA ARTIKEL SEAMLESS CANVAS */}
//         {/* ==================================================== */}
...
//       {/* FLOATING ACTION PILL (Mode Fokus Terlengkap) */}
//       <AnimatePresence>
//         {showFloatingBar && (
//           <motion.div
//             initial={{ y: 100 }}
//             animate={{ y: 0 }}
//             exit={{ y: 100 }}
//             className='fixed bottom-8 left-1/2 -translate-x-1/2 z-[110] no-print w-max'>
//             <div className='bg-slate-900/90 backdrop-blur-2xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.4)] rounded-full px-2 py-2 flex items-center gap-1'>
//               <button
//                 onClick={scrollToTop}
...
//               {/* FITUR 1: Auto Scroll (Khutbah Mode) */}
//               <button
//                 onClick={() => setIsAutoScrolling(!isAutoScrolling)}
//                 className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isAutoScrolling ? 'bg-teal-500 text-white animate-pulse shadow-md' : 'text-white hover:bg-white/10'}`}
...
//                 className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isBionic ? 'bg-amber-500 text-white shadow-[0_0_15px_rgba(245,158,11,0.5)]' : 'text-white hover:bg-white/10'}`}
...
//                 className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isFocusRuler ? 'bg-indigo-500 text-white shadow-[0_0_15px_rgba(99,102,241,0.5)]' : 'text-white hover:bg-white/10'}`}
...
//                 className='w-10 h-10 rounded-full hover:bg-white/10 flex items-center justify-center text-white relative'
...
//                 className={`w-10 h-10 rounded-full flex items-center justify-center transition-all ${isSpeaking ? 'bg-teal-500 text-white animate-pulse' : 'text-white hover:bg-white/10'}`}
...
//               <button
//                 onClick={handleShare}
//                 className='px-4 md:px-5 h-10 rounded-full bg-teal-500 hover:bg-teal-400 text-white font-bold text-sm flex items-center shadow-lg shadow-teal-500/30 transition-colors ml-1'>
