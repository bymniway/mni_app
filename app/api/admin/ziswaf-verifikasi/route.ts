...
//     if (isDiterima) {
//       // DITERIMA HTML (Garis putus-putus di footer, teks E-Invoice centered)
//       htmlBody = `
...
//           <tr>
//             <td style="padding: 30px 40px; border-bottom: 4px solid #0f766e; background-color: #ffffff;">
...
//                     <p style="margin: 0; font-size: 10px; font-weight: bold; color: #94a3b8;">Masjid Nurul Iman</p>
//                   </td>
//                 </tr>
//               </table>
//             </td>
...
//               <p style="font-size: 14px; color: #475569; line-height: 1.6; margin: 0 0 35px 0; position: relative; z-index: 2;">Jazakumullah Khairan Katsiran, <strong>${namaDonatur}</strong>. <br/>${intro}</p>
...
//                   <td align="right" style="padding: 12px 0; border-bottom: 1px solid #f1f5f9; font-weight: 900; color: #0f766e;">${trxData.kategori}</td>
//                 </tr>
//                 <tr>
...
//                   <td align="right" style="padding: 20px 15px; background-color: #ecfdf5; border-radius: 0 12px 12px 0; font-weight: 900; font-size: 18px; color: #0f766e;">${formatRp}</td>
//                 </tr>
//               </table>
...
//                 <p style="margin: 0 0 10px 0; font-size: 20px; font-weight: bold; color: #065f46; line-height: 1.6; font-family: 'Amiri', 'Traditional Arabic', serif;" dir="rtl">${msgUtama}</p>
...
//                     E-Invoice ini diterbitkan secara otomatis oleh Sistem Informasi Masjid MNI.
//                   </td>
//                 </tr>
//               </table>
//             </td>
...
//           <tr>
//             <td style="background-color: #fef2f2; padding: 40px; text-align: center; border-bottom: 1px solid #fee2e2;">
...
//       html: `<div style="background-color: #f1f5f9; padding: 40px 10px;">${htmlBody}</div>`,
//     });
