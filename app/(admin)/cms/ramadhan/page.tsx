...
export default function EditorHalamanRamadhan() {
  ...
  const handlePublish = async () => {
    ...
    const updates = [
      ...
      { kunci: 'ramadhan_hero_deskripsi', nilai: form.ramadhan_hero_deskripsi },
      { kunci: 'ramadhan_tahun_aktif', nilai: activeYear }, // Simpan tahun aktif
    ];
    ...
    setIsSaving(false);
    alert('Seluruh pengaturan Halaman Ramadhan berhasil dipublikasikan!');
  };

  // Filter data berdasarkan Tahun Aktif agar viewnya berganti
  ...
  const handleScheduleAdd = async () => {
    try {
      ...
      const newSchedule = {
        ...
        tahun_hijriyah: activeYear, // Gunakan tahun yang sedang aktif
        imam: 'Nama Imam',
        bilal: 'Nama Bilal',
  ...
  return (
    <div className='relative'>
      ...
      <div className='bg-slate-50/50 -mx-4 md:-mx-8 py-8 min-h-screen pointer-events-auto'>
        {/* HANYA PASSING DATA AKTIF (YANG SUDAH DIFILTER BERDASARKAN TAHUN) */}
        <RamadhanUI
          form={form}
