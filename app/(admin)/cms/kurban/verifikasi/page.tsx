...
//   // Format Status agar tidak UPPERCASE
...
//         }),
//       });
//       console.log('Data kurban berhasil dicatat ke Google Sheets');
//     } catch (err) {
...
//   // =========================================================================
//   // LOGIKA VERIFIKASI PINTAR (MEMAHAMI URUNAN & OTOMATIS/MANUAL)
//   // =========================================================================
...
//     try {
//       // 1. Panggil API Verifikasi Kurban (Update Database & Kirim Email)
...
//           alasanTolak: alasanTolak, // DIKIRIM KE BACKEND AGAR MASUK EMAIL
//         }),
//       });
...
//       // === SINKRONISASI GOOGLE SHEETS JIKA LUNAS ===
//       if (status === 'Lunas') {
//         await syncToGoogleSheet(selectedTrx);
//       }

//       // 2. Logika Kuota Hewan Terjual
//       if (status === 'Lunas') {
//         const isOtomatis =
...
//       setAlasanTolak('');
//       fetchPesanan(selectedTrx.id); // Refresh data
//     } catch (error: any) {
//       console.error(error);
...
//           Cek bukti transfer dan sahkan pendaftaran pequrban.
//         </p>
//       </div>

//       {/* SPLIT PANE LAYOUT (Seimbang 5 : 7) */}
//       <div className='grid grid-cols-1 lg:grid-cols-12 gap-5 flex-1 min-h-0'>
//         {/* ================= PANEL KIRI (ANTREAN 5 KOLOM) ================= */}
...
//               {['Semua', 'Booking', 'Menunggu', 'Lunas', 'Ditolak'].map((f) => (
//                 <button
//                   key={f}
//                   onClick={() => setFilter(f)}
...
//         {/* ================= PANEL KANAN (DETAIL SATU KOLOM 7 KOLOM GRID) ================= */}
