...
//   const [timelineList, setTimelineList] = useState<any[]>([]); // STATE BARU
...
//       }
//       // AMBIL SEMUA DATA (TANPA LIMIT) AGAR BAR SLOT URUNAN SELALU AKURAT
...
//         parseJSON('kurban_timeline_data', setTimelineList, []); // FETCH TIMELINE
//       }
//       setIsLoading(false);
//     };
//     fetchData();
...
//   // HANDLE UBAH ARRAY (TERMASUK BOOLEAN UNTUK TOGGLE AKTIF)
...
//       { kunci: 'kurban_timeline_data', nilai: JSON.stringify(timelineList) }, // SIMPAN TIMELINE
//     ];
...
//           timelineList={timelineList} // PASS TIMELINE DATA
